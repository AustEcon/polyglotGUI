...
if [ "$TRAVIS_REPO_SLUG" != "AustEcon/polyglotGUI" ] || [ "$TRAVIS_PULL_REQUEST" != "false" ] || [ "$TRAVIS_BRANCH" != "master" ]
then
...
git remote add upstream "https://$GH_TOKEN@github.com/AustEcon/polyglotGUI.git"
git fetch upstream
